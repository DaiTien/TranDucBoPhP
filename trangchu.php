...
<div class="wrapper">
        ...
        <div class="header-part header-reduce sticky">
                ...
                <div class="container">
                    <div class="header-top-inner">
                        <div class="header-top-left">
                            <a href="#" class="top-cell"><img src="~/asset/web/images/fon.png" alt=""> <span>123-456-7890</span></a>
            ...
            <div class="header-bottom">
                <div class="container">
                    <div class="header-info">
                        <div class="header-info-inner">
                            ...
                            <div class="shop-cart header-collect">
                                <a href="#"><img src="~/asset/web/images/icon-basket.png" alt="">2 items - $ 20.89</a>
                                <div class="cart-wrap">
                                    <div class="cart-blog">
                                        <div class="cart-item">
                                            <div class="cart-item-left">
                                                <img src="~/asset/web/images/img59.png" alt="">
                                            </div>
                                        ...
                                        <div class="cart-item">
                                            <div class="cart-item-left">
                                                <img src="~/asset/web/images/img60.png" alt="">
                                            </div>
                                            <div class="cart-item-right">
                                                <h6>Caramel Chesse Cake</h6>
                                                <span>$ 14.00</span>
                                        ...
                                        <div class="drop-mega-part">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 col-sm-12 col-xs-12">
                                                    ...
                                                    <img src="~/asset/web/images/img13.png" alt="">
                                                </div>
                                                <div class="col-md-5 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="mega-position"><img src="~/asset/web/images/img14.png" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div class="logo">
                        <a href="trangchu.html"><img src="/images/logo.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main>
        <div class="main-part">
                    ...
                    <div class="tp-banner">
                        <ul>
                            <li data-transition="zoomout" data-slotamount="2" data-masterspeed="1000" data-thumb="" data-saveperformance="on" data-title="Slide">
                                <img src="~/asset/web/images/dummy.png" alt="slidebg1" data-lazyload="~/asset/web/images/slider1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                                <!-- LAYERS -->
                                <div class="tp-caption very_large_text" data-x="center" data-hoffset="0" data-y="250" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                                     data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300">WE’RE <span>LABOOM</span> <i>Restaurant</i>
                                </div>
                                <!-- LAYERS -->
                                <div class="tp-caption medium_text" data-x="center" data-hoffset="0" data-y="340" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                                     data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300">Traditional Turkish Delicacies
                                </div>
                                <!-- LAYERS -->
                                <div class="tp-caption" data-x="center" data-hoffset="0" data-y="425" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                                     data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300"><a href="#" class="button-white">Explore NOW</a>
                                </div>
                            </li>
                            <li data-transition="zoomout" data-slotamount="2" data-masterspeed="1000" data-thumb="" data-saveperformance="on" data-title="Slide">
                                <img src="~/asset/web/images/dummy.png" alt="slidebg1" data-lazyload="~/asset/web/images/slider1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <p>Welcome. This is La Boom. Elegant &amp; sophisticated restaurant template. Royal plate offers different home page layouts with smart and unique design, showcasing beautifully designed elements every restaurant website should
                                have. Smooth animations, fast loading and engaging user experience are just some of , the features this template offers. So, give it a try and dive into a world of La Boom restaurant websites.</p>
                            <p><img src="~/asset/web/images/signature.png" alt=""></p>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <img src="~/asset/web/images/img2.png" alt="">
                        </div>
                    </div>
                </div>
            ...
            <!-- End Welcome Part -->
            <!-- Start Dishes Part -->
            <section class="dishes banner-bg invert invert-black home-icon wow fadeInDown" data-background="/images/banner1.jpg" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <div class="container">
                    ...
                    <div class="slider multiple-items">
                        <div class="product-blog">
                            <img src="~/asset/web/images/product1.png" alt="">
                            <h3>Quattro Formaggi</h3>
                            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames</p>
                            <del>$ 55.00</del><strong class="txt-default">$ 18.00</strong>
                        </div>
                        <div class="product-blog">
                            <img src="~/asset/web/images/product2.png" alt="">
                            <h3>Vegetarian Pasta</h3>
                            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames</p>
                            <del>$ 55.00</del><strong class="txt-default">$ 18.00</strong>
                        </div>
                        <div class="product-blog">
                            <img src="~/asset/web/images/product3.png" alt="">
                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="portfolioContainer row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 isotope-item dessert">
                                <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="~/asset/web/images/img5.png" alt="">
                                        </span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 isotope-item dinner">
                                <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="~/asset/web/images/img6.png" alt="">
                                        </span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 isotope-item freshfood">
                                <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="~/asset/web/images/img7.png" alt="">
                                        </span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 isotope-item freshfood">
                                <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="~/asset/web/images/img8.png" alt="">
                                        </span>
            ...
            <section class="chef-part home-icon wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                    ...
                    <div class="owl-carousel owl-theme chef-slider" data-items="4" data-laptop="3" data-tablet="2" data-mobile="1" data-nav="true" data-dots="false" data-autoplay="true" data-speed="1800" data-autotime="5000">
                            ...
                            <div class="chef-blog">
                                <div class="chef-inner">
                                    <div class="chef-member">
                                        <img src="~/asset/web/images/chef1.png" alt="">
                                    </div>
                                    <div class="chef-info">
                                        <h5>Anna Taylor</h5>
                        ...
                        <div class="item">
                            <div class="chef-blog">
                                <div class="chef-inner">
                                    <div class="chef-member">
                                        <img src="~/asset/web/images/chef2.png" alt="">
                                    </div>
                                    <div class="chef-info">
                                        <h5>Alex Wilson</h5>
                                        <span>Head Chief</span>
                        ...
                        <div class="item">
                            <div class="chef-blog">
                                <div class="chef-inner">
                                    <div class="chef-member">
                                        <img src="~/asset/web/images/chef3.png" alt="">
                                    </div>
                                    <div class="chef-info">
                                        <h5>Anita Golden</h5>
                                        <span>Head Chief</span>
                        ...
                        <div class="item">
                            <div class="chef-blog">
                                <div class="chef-inner">
                                    <div class="chef-member">
                                        <img src="~/asset/web/images/chef4.png" alt="">
                                    </div>
                                    <div class="chef-info">
                ...
                <div class="float-main">
                    <div class="icon-top-left">
                        <img src="~/asset/web/images/icon12.png" alt="">
                    </div>
                    <div class="icon-bottom-left">
                        <img src="~/asset/web/images/icon13.png" alt="">
                    </div>
                    <div class="icon-top-right">
                        <img src="~/asset/web/images/icon14.png" alt="">
                    </div>
                </div>
            </section>
            <!-- End Chef -->
                        ...
                        <div class="owl-carousel owl-theme" data-items="3" data-laptop="3" data-tablet="2" data-mobile="1" data-nav="true" data-dots="false" data-autoplay="true" data-speed="1800" data-autotime="5000">
                            <div class="item">
                                <div class="feature-img">
                                    <img src="~/asset/web/images/feature1.jpg" alt="">
                            ...
                            <div class="item">
                                <div class="feature-img">
                                    <img src="~/asset/web/images/feature2.jpg" alt="">
                                    <div class="date-feature">27
                                        <br> <small>may</small></div>
                                </div>
                                <div class="feature-info">
                            ...
                            <div class="item">
                                <div class="feature-img">
                                    <img src="~/asset/web/images/feature3.jpg" alt="">
                                    <div class="date-feature">27
                                        <br> <small>may</small></div>
                                </div>
                                <div class="feature-info">
            ...
            <section class="instagram-main home-icon wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <div class="gallery-slider">
                    <div class="owl-carousel owl-theme" data-items="6" data-laptop="5" data-tablet="4" data-mobile="1" data-nav="true" data-dots="false" data-autoplay="true" data-speed="2000" data-autotime="3000">
                        <div class="item">
                            <a href="~/asset/web/images/gallery-big1.jpeg" class="magnific-popup">
                                <img src="~/asset/web/images/gallery1.png" alt="" class="animated">
                        ...
                        <div class="item">
                            <a href="~/asset/web/images/gallery-big2.jpeg" class="magnific-popup">
                                <img src="~/asset/web/images/gallery2.png" alt="" class="animated">
                                <div class="gallery-overlay">
                                    <div class="gallery-overlay-inner">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div class="item">
                            <a href="~/asset/web/images/gallery-big3.jpeg" class="magnific-popup">
                                <img src="~/asset/web/images/gallery3.png" alt="" class="animated">
                                <div class="gallery-overlay">
                                    <div class="gallery-overlay-inner">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div class="item">
                            <a href="~/asset/web/images/gallery-big4.jpeg" class="magnific-popup">
                                <img src="~/asset/web/images/gallery4.png" alt="" class="animated">
                                <div class="gallery-overlay">
                                    <div class="gallery-overlay-inner">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div class="item">
                            <a href="~/asset/web/images/gallery-big5.jpeg" class="magnific-popup">
                                <img src="~/asset/web/images/gallery5.png" alt="" class="animated">
                                <div class="gallery-overlay">
                                    <div class="gallery-overlay-inner">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div class="item">
                            <a href="~/asset/web/images/gallery-big6.jpeg" class="magnific-popup">
                                <img src="~/asset/web/images/gallery6.png" alt="" class="animated">
                                <div class="gallery-overlay">
                                    <div class="gallery-overlay-inner">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
...
<script src="~/asset/web/js/jquery.formstyler.min.js"></script>
<script src="~/asset/web/js/jquery.themepunch.plugins.min.js"></script>
<script src="~/asset/web/js/jquery.themepunch.revolution.min.js"></script>
<script src="~/asset/web/js/owl.carousel.min.js"></script>
<script src="~/asset/web/js/slick.min.js"></script>
<script src="~/asset/web/js/isotop.js"></script>
<script src="~/asset/web/js/packery-mode.pkgd.min.js"></script>
