<header class="main-header">
    ...
    <a href="indexadmin/Dashboard" class="logo">
        ...
        <span class="logo-lg"><b>Trần Đức Bo</b>.Admin</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?php echo 'Xin chào ' .$user ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="?c=indexadmin&a=logout" class="btn btn-default btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
