            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <a href="?c=NewsAdmin&a=Insert" class="btn btn-primary glyphicon glyphicon-plus">Add</a>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-danger glyphicon glyphicon-trash btn-sm" href="?c=NewsAdmin&a=Delete&id=<?=$value->id?>"></a>
                                            <a class="btn btn-primary glyphicon glyphicon-pencil btn-sm" href="?c=NewsAdmin&a=Update&id=<?=$value->id?>"></a>
                                        </td>
                                    </tr>
                                <?php
                                }
