    ...
    <main>
        <div class="main-part">
            ...
            <section class="anna-form home-icon bg-skeen wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <div class="container">
                    <div class="build-title">
                        <h2>Send Message to Anna</h2>
                    </div>
                    <div class="anna-form-inner wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                <input type="submit" name="Send Message" value="Send Message" class="btn-main">
                            </div>
                        </div>
                    </div>
                </div>
