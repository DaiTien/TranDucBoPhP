            ...
            <div class="header-part header-reduce sticky">
                    ...
                    <div class="container">
                        <div class="header-top-inner">
                            <div class="header-top-left">
                                <a href="#" class="top-cell"><img src="/TranDucBoPhp/asset/web/images/fon.png" alt=""> <span>123-456-7890</span></a>
                ...
                <div class="header-bottom">
                    <div class="container">
                        <div class="header-info">
                            <div class="header-info-inner">
                                ...
                                <div class="shop-cart header-collect">
                                    <a href="#"><img src="/TranDucBoPhp/asset/web/images/icon-basket.png" alt="">2 items - $ 20.89</a>
                                    <div class="cart-wrap">
                                        <div class="cart-blog">
                                            <div class="cart-item">
                                                <div class="cart-item-left">
                                                    <img src="/TranDucBoPhp/asset/web/images/img59.png" alt="">
                                                </div>
                                            ...
                                            <div class="cart-item">
                                                <div class="cart-item-left">
                                                    <img src="/TranDucBoPhp/asset/web/images/img60.png" alt="">
                                                </div>
                                                <div class="cart-item-right">
                                                    <h6>Caramel Chesse Cake</h6>
                                                    <span>$ 14.00</span>
                                            ...
                                            <div class="drop-mega-part">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 col-sm-12 col-xs-12">
                                                        ...
                                                        <img src="/TranDucBoPhp/asset/web/images/img13.png" alt="">
                                                    </div>
                                                    <div class="col-md-5 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="mega-position"><img src="/TranDucBoPhp/asset/web/images/img14.png" alt=""></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="logo">
                            <a href="trangchu.html"><img src="/TranDucBoPhp/asset/web/images/logo.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="main-part">
                ...
                <section class="slide">
                    <div class="slider__list">
                        <div class="slider__item">
                            <img src="/TranDucBoPhp/asset/web/images/slider1.jpg" alt="">
                        </div>
                        <div class="slider__item">
                            <img src="/TranDucBoPhp/asset/web/images/slider1.jpg" alt="">
                        </div>
                ...
                <section id="reach-to" class="welcome-part home-icon">
                    <div class="icon-default">
                        <a href="#reach-to" class="scroll"><img src="/TranDucBoPhp/asset/web/images/scroll-arrow.png" alt=""></a>
                    </div>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                                ...
                                <p><img src="/TranDucBoPhp/asset/web/images/signature.png" alt=""></p>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                                <img src="/TranDucBoPhp/asset/web/images/img2.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="float-main">
                        <div class="icon-top-left">
                            <img src="/TranDucBoPhp/asset/web/images/icon1.png" alt="">
                        </div>
                        <div class="icon-bottom-left">
                            <img src="/TranDucBoPhp/asset/web/images/icon2.png" alt="">
                        </div>
                        <div class="icon-top-right">
                            <img src="/TranDucBoPhp/asset/web/images/icon3.png" alt="">
                        </div>
                        <div class="icon-bottom-right">
                            <img src="/TranDucBoPhp/asset/web/images/icon4.png" alt="">
                        </div>
                    </div>
                </section>
                <!-- End Welcome Part -->
                <!-- Start Dishes Part -->
                <section class="dishes banner-bg invert invert-black home-icon wow fadeInDown" data-background="/TranDucBoPhp/asset/web/images/banner1.jpg" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="icon-default icon-black">
                        <img src="/TranDucBoPhp/asset/web/images/icon5.png" alt="">
                    </div>
                    <div class="container">
                        <div class="build-title">
                            <h2>Welcome To The La Boom</h2>
                        ...
                        <div class="slider multiple-items">
                            <div class="product-blog">
                                <img src="/TranDucBoPhp/asset/web/images/product1.png" alt="">
                                <h3>Quattro Formaggi</h3>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames</p>
                                <del>$ 55.00</del><strong class="txt-default">$ 18.00</strong>
                            </div>
                            <div class="product-blog">
                                <img src="/TranDucBoPhp/asset/web/images/product2.png" alt="">
                                <h3>Vegetarian Pasta</h3>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames</p>
                                <del>$ 55.00</del><strong class="txt-default">$ 18.00</strong>
                            </div>
                            <div class="product-blog">
                                <img src="/TranDucBoPhp/asset/web/images/product3.png" alt="">
                        ...
                        <div class="menu-wrapper">
                            ...
                            <div class="portfolioContainer row">
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item breakfast">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="/TranDucBoPhp/asset/web/images/img3.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item lunch">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="/TranDucBoPhp/asset/web/images/img4.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item dessert">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="/TranDucBoPhp/asset/web/images/img5.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item dinner">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="/TranDucBoPhp/asset/web/images/img6.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item freshfood">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="/TranDucBoPhp/asset/web/images/img7.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item freshfood">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="/TranDucBoPhp/asset/web/images/img8.png" alt="">
                                        </span>
                ...
                <section class="chef-part home-icon wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                        ...
                        <div class="owl-carousel owl-theme chef-slider" data-items="4" data-laptop="3" data-tablet="2" data-mobile="1" data-nav="true" data-dots="false" data-autoplay="true" data-speed="1800" data-autotime="5000">
                                ...
                                <div class="chef-blog">
                                    <div class="chef-inner">
                                        <div class="chef-member">
                                            <img src="/TranDucBoPhp/asset/web/images/chef1.png" alt="">
                                        </div>
                                        <div class="chef-info">
                                            <h5>Anna Taylor</h5>
                            ...
                            <div class="item">
                                <div class="chef-blog">
                                    <div class="chef-inner">
                                        <div class="chef-member">
                                            <img src="/TranDucBoPhp/asset/web/images/chef2.png" alt="">
                                        </div>
                                        <div class="chef-info">
                                            <h5>Alex Wilson</h5>
                                            <span>Head Chief</span>
                            ...
                            <div class="item">
                                <div class="chef-blog">
                                    <div class="chef-inner">
                                        <div class="chef-member">
                                            <img src="/TranDucBoPhp/asset/web/images/chef4.png" alt="">
                                        </div>
                                        <div class="chef-info">
                    ...
                    <div class="float-main">
                        <div class="icon-top-left">
                            <img src="/TranDucBoPhp/asset/web/images/icon12.png" alt="">
                        </div>
                        <div class="icon-bottom-left">
                            <img src="/TranDucBoPhp/asset/web/images/icon13.png" alt="">
                        </div>
                        <div class="icon-top-right">
                            <img src="/TranDucBoPhp/asset/web/images/icon14.png" alt="">
                        </div>
                    </div>
                </section>
                <!-- End Chef -->
                            ...
                            <div class="owl-carousel owl-theme" data-items="3" data-laptop="3" data-tablet="2" data-mobile="1" data-nav="true" data-dots="false" data-autoplay="true" data-speed="1800" data-autotime="5000">
                                <div class="item">
                                    <div class="feature-img">
                                        <img src="/TranDucBoPhp/asset/web/images/feature1.jpg" alt="">
                                ...
                                <div class="item">
                                    <div class="feature-img">
                                        <img src="/TranDucBoPhp/asset/web/images/feature2.jpg" alt="">
                                        <div class="date-feature">27
                                            <br> <small>may</small></div>
                                    </div>
                                    <div class="feature-info">
                                ...
                                <div class="item">
                                    <div class="feature-img">
                                        <img src="/TranDucBoPhp/asset/web/images/feature3.jpg" alt="">
                                        <div class="date-feature">27
                                            <br> <small>may</small></div>
                                    </div>
                                    <div class="feature-info">
